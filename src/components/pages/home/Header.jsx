...
const Header = () => {
  return (
    <header className=" h-screen w-full bg-cover " style={{backgroundImage: `url(${Lines})`}}>
        <Container>
            <div className=" w-full h-full flex justify-center items-center  ">
                <div className=" w-full text-center h-full pt-[30px] md:pt-[144px]">
                    ...
                    <div className=" w-full flex flex-col md:flex-row items-center md:justify-center gap-4">
                        <Button varient="contained" color="primary" size="medium" typpe="link">Sign  up</Button>
                        <Button varient="contained" color="secondary" size="medium" typpe="link">Log in</Button>
                    </div>
                </div>
            </div>
        </Container>
