        ...
        <Container>
            <div className=" py-[65px] flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-5">
                  <Button to='/register' varient='contained' color='default' size='medium' typpe='link'>Sign  up</Button>
                  <Button to='/login' varient='outlined' color='default'  size='medium' typpe='link'>Log in</Button>
                </div>
            </div>
        </Container>
    </div>
