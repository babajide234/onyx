...
const SectionMid = () => {
  return (
    <div className="">
        <Container>
            <div className=" py-11 px-[180px]">
                <SectionHeading>
                    <p className=" text-base leading-[35px] text-center mb-10">
                    ...
                    And now you have it. We’re glad you’re here. <br/>

                    Connect with us. Browse our resources. Join our community.<br/>
