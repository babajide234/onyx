    ...
    <>
      <Container>
        <div className=" flex justify-between ">
          <div className=" w-[60%] grid grid-cols-1 md:grid-cols-2 gap-10 pr-10 py-10">
            {posts &&
              posts.data.map((post, index) => (
                <EventCard item={post} key={index} />
              ))}
          </div>
          <div className="  w-[30%] flex flex-col py-10">
            <div className="  px-[2rem] py-[3.5rem] flex flex-col items-center justify-center text-center">
